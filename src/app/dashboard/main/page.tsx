          ...
          <div>
            ...
            <div className="space-y-2">
              <p className="text-gray-600">
                Din pakke er: <span className="font-medium text-[#BC1964]">{subscription?.name || 'Ingen aktiv pakke'}</span>
              </p>
              <p className="text-gray-600">
                Du har <span className="font-medium text-[#1AA49A]">{subscription?.available_slots || 0}</span> ledige produktpladser ud af <span className="font-medium text-[#BC1964]">{subscription?.total_slots || 0}</span> i alt
              </p>
              <p className="text-gray-600">
                Du har <span className="font-medium text-[#1AA49A]">{subscription?.days_remaining || 0}</span> dage tilbage af dit abonnement
              </p>
            </div>
          </div>
